...
export const PRODUCTS: Product[] = [
  ...
  {
    id: 11,
    name: 'name: Аэрогриль Denx DX1786 4 л черный',
    description: 'DENX DX1786 — это современная фритюрница-аэрогриль, которая позволяет готовить вкусные блюда с минимальным количеством масла. Компактный и стильный дизайн впишется в любую кухню, а высокая мощность обеспечит быстрый результат.\n' +
      '\n',
    price: 16800,
    rating: 5.0,
    image: 'products/gr1.jpg',
    images: ['products/gr1.jpg', 'products/gr2.jpg', 'products/gr3.jpg'],
    link: 'https://kaspi.kz/shop/p/denx-dx1786-chernyi-130291881/?c=750000000',
  ...
  {
    id: 12,
    name: 'Аэрогриль Tefal EY505D15 4.2 л серебристый',
    description: 'ЭКОНОМИЯ ВРЕМЕНИ..Аэрогриль Easy Fry Grill обладает мощностью в 1550 Вт, блюда в нём готовятся на 49% быстрее. Воздух в аэрогриле циркулирует быстро и равномерно, прогревая продукт со всех сторон. В результате блюдо получается сочным внутри и с хрустящей корочкой.',
    price: 87980,
    rating: 4.8,
    image: 'products/grl1.jpg',
    images: ['products/grl1.jpg', 'products/grl2.jpg', 'products/grl3.jpg'],
    link: 'https://kaspi.kz/shop/p/tefal-ey505d15-serebristyi-116903923/?c=750000000',
...

  {
    ...
    description: 'Откройте для себя инновации и стиль с умными часами Arteo АS10, идеально сочетая функциональность и элегантность. Эти смарт-часы созданы для активных и современных людей, которые ценят удобство и высокие технологии.',
    price: 9990,
    rating: 5.0,
    image: 'products/wh1.jpg',
    images: ['products/wh1.jpg', 'products/wh2.jpg', 'products/wh3.jpg'],
  ...
  {
    id: 14,
    name: 'Смарт-часы Garmin Venu 4s 41 мм золотистый-белый',
    description: 'Созданные для достижения ваших целей, новые смарт-часы с GPS Venu 4 специально разработаны с расширенными функциями, которые помогут вам лучше понять свой организм и способствовать более здоровому образу жизни. Благодаря тому, что модель 41 мм. работает от аккумулятора до 10 дней, а 45 мм. - до 12 дней, вы сможете получить более полное представление о своем здоровье. ',
    price: 342990,
    rating: 4.8,
    image: 'products/whc1.jpg',
    images: ['products/whc1.jpg', 'products/whc2.jpg', 'products/whc3.jpg'],
    link: 'https://kaspi.kz/shop/p/garmin-venu-4s-41-mm-zolotistyi-belyi-147026783/?c=750000000',
...

  {
    ...
    description: 'редставляем вам наушники HYDRA Minor — идеальный выбор для тех, кто ценит комфорт и высокое качество звука в любом месте и в любое время. Эти беспроводные наушники обеспечивают чистый звук и долгую работу без проводов.',
    price: 4990,
    rating: 4.7,
    image: 'products/141.jpg',
    images: ['products/141.jpg', 'products/142.jpg', 'products/143.jpg'],
...

  {
    ...
    description: '🎧 ZQ Air by QUEZQA — полноразмерные беспроводные наушники для любых устройств\n' +
      'Подходят для ТВ, ноутбука, смартфона, планшета и консоли.',
    price: 7499,
    rating: 4.8,
    image: 'products/151.jpg',
    images: ['products/151.jpg', 'products/152.jpg', 'products/153.jpg'],
  ...
  {
    id: 17,
    name: 'Наушники Cheezle CR-8 коричневый',
    description: 'Накладные наушники Cheezle CR-8 — это сочетание глубокого звука, современных технологий и премиального дизайна. Они созданы для тех, кто ценит качество, удобство и стиль как в дороге, так и на работе или отдыхе.\n' +
      '\n',
    price: 7999,
    rating: 4.8,
    image: 'products/171.jpg',
    images: ['products/171.jpg', 'products/172.jpg', 'products/173.jpg'],
    link: 'https://kaspi.kz/shop/p/naushniki-cheezle-cr-8-korichnevyi-150271323/?c=750000000',
...

  {
    ...
    description: 'Jasper JS70 — свобода звука в твоём ритме\n' +
      'Эти наушники созданы для тех, кто хочет получать максимум от музыки и общения. Стильный дизайн, удобная посадка и современная начинка делают JS70 идеальным спутником на каждый день.',
    price: 3490,
    rating: 4.8,
    image: 'products/181.jpg',
    images: ['products/181.jpg', 'products/182.jpg', 'products/183.jpg'],
  ...
  {
    id: 19,
    name: 'Смарт-часы Mobile Republic Sport Ray 47 мм черно-серый-серебристый',
    description: 'Смарт-часы Sport Ray— надежный помощник для активной жизни, сочетающий прочность, точный трекинг и удобную связь со смартфоном.',
    price: 35000,
    rating: 4.8,
    image: 'products/191.jpg',
    images: ['products/191.jpg', 'products/192.jpg', 'products/193.jpg'],
    link: 'https://kaspi.kz/shop/p/mobile-republic-sport-ray-47-mm-cherno-seryi-serebristyi-150961969/?c=750000000',
